...
namespace Pkn_HostSystem.Views.Pages
{
    ...
    public partial class HomePage : Page
    {
        ...
        private void CA_ConnectPLC_Click(object sender, System.Windows.RoutedEventArgs e)
        {
            ...
            CA_pppOrderSelect.Visibility= Visibility.Collapsed;
        ...
        private void CA_pppOrderSelect_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            border.Visibility = Visibility.Collapsed;
            Storyboard? storyboard = FindResource("OpenPppOrder") as Storyboard;
            storyboard?.Begin();
        }
        private void ButtonBase_OnClick2(object sender, RoutedEventArgs e)
        {
            Storyboard? storyboard = FindResource("ClosePppOrder") as Storyboard;
            storyboard?.Begin();
            Task.Run(async () =>
                {
                    await Task.Delay(300);
